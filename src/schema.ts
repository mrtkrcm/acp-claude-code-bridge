...
// MCP Resource Tool Schemas
export const listMcpResourcesRequestSchema = z.object({
  server_name: z.string().optional(),
  sessionId: z.string(),
});

export const readMcpResourceRequestSchema = z.object({
  uri: z.string(),
  sessionId: z.string(),
});
...
export const listMcpResourcesResponseSchema = z.object({
...
export const readMcpResourceResponseSchema = z.object({
...
// Export types
export type ListMcpResourcesRequest = z.infer<typeof listMcpResourcesRequestSchema>;
export type ReadMcpResourceRequest = z.infer<typeof readMcpResourceRequestSchema>;
export type McpToolCallRequest = z.infer<typeof mcpToolCallRequestSchema>;
export type ListMcpResourcesResponse = z.infer<typeof listMcpResourcesResponseSchema>;
export type ReadMcpResourceResponse = z.infer<typeof readMcpResourceResponseSchema>;
